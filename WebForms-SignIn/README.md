# An ASP.NET framework(Vb.net) Web forms signing-in users with the Microsoft identity platform in your organization

## Scenario

This sample shows how to build a Vb.net web forms that uses OpenID Connect to sign in users. Users can only sign-in with their `work and school` accounts in their own organization. It leverages the OWIN middleware component.

![Sign in with Azure AD](ReadmeFiles/sign-in.png)

> This is the first chapter of this Vb.net web forms tutorial. Once you understand how to sign-in users in an Vb.net web forms with Open Id Connect, can learn how to enable your Web App to call a Web API on behalf of the signed-in user.
...
1. In the list of pages for the app, select **Authentication**..
   - In the Redirect URIs section, select **Web** in the combo-box and enter the following redirect URIs.
    ...
    - `https://localhost:44307/`
   - In the **Advanced settings** section set **Logout URL** to `https://localhost:44307/`
...
This sample shows how to use the OpenID Connect vb.net webforms using OWIN middleware to sign in users from a single Azure AD tenant. The middleware is initialized in the `Startup.vb` file by passing it the Client ID of the app, and the URL of the Azure AD tenant where the app is registered. These values are  read from the `web.config` file. The middleware takes care of:
